 ...
 */
public class FetchDataTask extends AsyncTask<String, Void, ArrayList<Movie>>   {
    ...
    private ArrayList<Movie> getMoviesListFromJson(String moviesJsonStr) throws JSONException{
        ...
        final double MOVIE_VOTE_AVERAGE = Double.parseDouble("vote_average");
...
//            Double voteAverage;
            ...
            double voteAverage = movieJsonObject.getDouble(String.valueOf(MOVIE_VOTE_AVERAGE));
